...
################################################################################
######################### 5Y TRANSPORT COSTS CALCULATION #######################                                  <- 5Y TRANSPORT COSTS CALCULATION

# This code calculates the total transport costs incurred for each restoration method
# over a (adjustable) 5 year timeframe, based on:
# method (porters required? etc), location (road / off road transport? camping needed?)
...
costcalc <- paste(inDir,"restCosts_calc.r",sep="/")
tcostcalc <- paste(inDir,"tsportCosts_calc.r",sep="/")
...
r1             # Transport costs
v1             # Equipment costs
r2             # Sum of costs: Transport + Govt + Eqp
...
rel <- raster(paste(outR, "prox-agrd-vinesR.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-vinesO.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-shrubP.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-shrubR.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-shrubO.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-lantP.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-lantR.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-lantO.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-grassP.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-grassR.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-grassO.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-fireP.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-fireR.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-fireO.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-soilP.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-soilR.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
...
rel <- raster(paste(outR, "prox-agrd-soilO.tif", sep="/"))
r1 <- rel
r2 <- rel
r1[r1>1] <- NA
r2[r2<2] <- NA
